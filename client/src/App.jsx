...
// import { isAdmin, sendUserData } from './helper/api.js'; // We no longer need the broken isAdmin
import { sendUserData } from './helper/api.js'; // Keep sendUserData
...
  // --- THIS IS THE UPDATED ADMIN CHECK ---
  useEffect(() => {
    const checkAdmin = () => {
      if (user) {
...
      } else {
        // If no user, make sure admin is false
        setAdmin(false);
      }
    };
    checkAdmin();
  }, [user]); // This now runs whenever the user logs in or out
  // --- END OF UPDATE ---
